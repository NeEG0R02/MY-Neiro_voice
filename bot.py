...
def help_msg(message):
    bot.send_message(message.from_user.id,
                     "Отправь мне голосовое "
                     "сообщение или текст, чтобы преступить к общению!")
...
def stt(message):
    ...
    try:
        ...
        logging.error(e)
        bot.send_message(user_id, "Не получилось распознать голос. Попробуй записать "
...
def handle_text(message):
    try:
        ...
        logging.error(e)
        bot.send_message(message.from_user.id,
                         "Не получилось распознать голос. Попробуй написать другое сообщение")
...
def handle_voice(message):
    ...
    try:
        ...
        logging.error(e)
        bot.send_message(user_id,
                         "Не получилось распознать голос. Попробуй записать другое сообщение")
bot.polling()
